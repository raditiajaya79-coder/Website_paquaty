            ...
            <form onSubmit={handleSubmit} className="space-y-6 pb-8">
                ...
                <div className="p-3.5 bg-amber-50 border border-amber-200/80 rounded-xl">
                    <p className="text-[11px] font-bold text-amber-700 leading-relaxed text-center">
                        <strong className="text-amber-800">Jangan lupa!</strong> Klik tombol <span className="inline-flex items-center px-2 py-0.5 bg-indigo-100 text-indigo-600 rounded text-[9px] font-black uppercase tracking-widest">Magic Auto-Translate (EN)</span> sebelum menyimpan, agar teks bahasa Inggris terisi otomatis.
                    </p>
                </div>
