            ...
            <div className="bg-brand-cream min-h-screen pt-24 pb-16 md:py-32 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <motion.div {...fadeIn} className="text-center mb-16 md:mb-28">
                        <span className="text-brand-blue font-bold tracking-[0.4em] uppercase text-[10px] md:text-xs mb-6 block underline decoration-brand-blue/20 decoration-2 underline-offset-8">{t('certs.header_label')}</span>
                    ...
                    >
                        ...
                        <div className="relative z-10 max-w-2xl">
                            ...
                            <h2 className="text-3xl md:text-4xl font-medium mb-6 leading-tight">{t('certs.footer_title')}<span className="text-brand-gold">{t('certs.footer_title_accent')}</span></h2>
