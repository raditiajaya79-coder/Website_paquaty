            ...
            <div className="bg-[#FAFAF9] min-h-screen pt-32 pb-32">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <motion.header {...fadeIn} className="text-center mb-24 max-w-3xl mx-auto">
                        <span className="text-[#A3B14B] font-medium tracking-[0.4em] uppercase text-xs mb-6 block">Our Story</span>
                        <h1 className="text-5xl md:text-7xl font-medium text-[#1C1917] tracking-tight mb-8">
                            Rooted in Tradition, <br />
                            <span className="text-[#A3B14B]">Crafted for the World.</span>
                        </h1>
                    ...
                    <motion.section {...fadeIn} className="mb-32">
                        <div className="bg-[#1C1917] rounded-[2.5rem] p-10 md:p-16 relative overflow-hidden">
                            {/* Decorative elements */}
                            <div className="absolute top-0 right-0 w-64 h-64 bg-[#A3B14B] rounded-full blur-[100px] opacity-15 transform translate-x-1/3 -translate-y-1/3"></div>
                            <div className="absolute bottom-0 left-0 w-48 h-48 bg-[#A3B14B] rounded-full blur-[80px] opacity-10 transform -translate-x-1/3 translate-y-1/3"></div>

                            <div className="relative z-10">
                                <span className="text-[#A3B14B] font-medium tracking-[0.4em] uppercase text-xs mb-8 block">The Meaning Behind Our Name</span>
                                <h2 className="text-3xl md:text-5xl font-medium text-white tracking-tight mb-12">
                                    Bala Aditi <span className="text-[#A3B14B]">Pakuaty</span>
                                </h2>

                                <div className="grid md:grid-cols-3 gap-8 md:gap-12">
                                    <div className="border-l-2 border-[#A3B14B]/30 pl-6">
                                        <div className="flex items-center gap-3 mb-4">
                                            <Users className="w-6 h-6 text-[#A3B14B]" />
                                            <h3 className="text-xl font-semibold text-white">Bala</h3>
                                        </div>
                                        <p className="text-sm text-[#A3B14B] font-medium mb-3 italic">Sanskrit — "Team" or "Force"</p>
                                    ...
                                    <div className="border-l-2 border-[#A3B14B]/30 pl-6">
                                        <div className="flex items-center gap-3 mb-4">
                                            <Globe className="w-6 h-6 text-[#A3B14B]" />
                                            <h3 className="text-xl font-semibold text-white">Aditi</h3>
                                        </div>
                                        <p className="text-sm text-[#A3B14B] font-medium mb-3 italic">Sanskrit — "Global" or "Boundless"</p>
                                        <p className="text-neutral-400 leading-relaxed">
                                    ...
                                    <div className="border-l-2 border-[#A3B14B]/30 pl-6">
                                        <div className="flex items-center gap-3 mb-4">
                                            <Heart className="w-6 h-6 text-[#A3B14B]" />
                                            <h3 className="text-xl font-semibold text-white">Pakuaty</h3>
                                        </div>
                                        <p className="text-sm text-[#A3B14B] font-medium mb-3 italic">"Pakunya Hati" — "Nail of the Heart"</p>
                                        <p className="text-neutral-400 leading-relaxed">
                    ...
                    <motion.div {...fadeIn} className="text-center mb-16">
                        <span className="text-[#A3B14B] font-medium tracking-[0.4em] uppercase text-xs mb-4 block">What Drives Us</span>
                        <h2 className="text-4xl md:text-5xl font-medium text-[#1C1917] tracking-tight">Our Core Values</h2>
                    </motion.div>
                    ...
                    <motion.div {...fadeIn} className="text-center max-w-3xl mx-auto">
                        <div className="bg-[#A3B14B]/5 border border-[#A3B14B]/15 rounded-[2.5rem] p-10 md:p-16">
                            <h2 className="text-3xl md:text-4xl font-medium text-[#1C1917] tracking-tight mb-6">
                                Together, we bring <span className="text-[#A3B14B]">flavor</span>.<br />
                                Together, we build a <span className="text-[#A3B14B]">better world</span>.
                            </h2>
