 ...
 * Menampilkan konten lengkap artikel berdasarkan ID yang dipilih.
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content={t(`article.${articleId}.excerpt`)} />
            </Helmet>
            ...
            <div className="bg-neutral-bone min-h-screen pt-24 pb-16 md:pb-20">
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    >
                        ...
                        <div className="text-lg text-[#57534E] leading-[1.8] whitespace-pre-line space-y-6">
