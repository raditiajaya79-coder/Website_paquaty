...
const Products = () => {
    ...
    return (
        <>
            ...
            <div className="bg-[#020617] min-h-screen pt-32 pb-32 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-[800px] h-[800px] opacity-20 bg-blue-900/10 blur-3xl rounded-full"></div>

                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <motion.div {...fadeIn} className="text-center mb-24">
                        <span className="text-primary font-medium tracking-[0.4em] uppercase text-xs mb-6 block">Our Collection</span>
                        <h1 className="text-5xl md:text-7xl font-medium text-white tracking-tight mb-8">
                            Premium <span className="text-accent">Commodities</span>
                        </h1>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                        {PRODUCTS.map((product) => (
                            <Link to={`/products/${product.id}`} key={product.id} className="block group">
                                <motion.div
                                    {...fadeIn}
                                    className="bg-slate-900 rounded-3xl border border-white/5 hover:border-accent/50 transition-all duration-500 overflow-hidden"
                                >
                                    <div className="aspect-[4/5] relative overflow-hidden">
                                        ...
                                        {product.tag && (
                                            <span className="absolute top-6 left-6 z-20 px-4 py-1.5 rounded-full text-xs font-bold bg-accent text-stone-dark shadow-lg">
                                                {product.tag}
                                            </span>
                                        )}
                                    </div>
                                    ...
                                    <div className="p-8">
                                        ...
                                        <p className="text-accent font-medium mb-6">{product.grade}</p>
                                        ...
                                        <div className="flex justify-between items-center pt-6 border-t border-white/10">
                                            ...
                                            <div className="bg-white/5 hover:bg-accent text-white hover:text-stone-dark p-3 rounded-full transition-all group-hover:scale-110">
