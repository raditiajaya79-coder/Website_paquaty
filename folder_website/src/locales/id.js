export const id = {
    ...
    // Hero Section
    "hero.subtitle_part1": "MENDEFINISIKAN ULANG CAMILAN PROTEIN",
    "hero.title_part1": "Standar",
    "hero.title_part2": "Emas",
    "hero.subtitle_part2": "Keripik pengrajin yang dibuat melalui fermentasi tradisional 48 jam. Setiap irisan menceritakan kisah warisan.",
    "hero.explore": "Jelajahi Koleksi",
    "hero.story": "Tentang Kisah Kami",

    // Home - Products Section
    "products.artisan": "Pengerjaan",
    "products.chips": "Keripik Tempe",
    "products.desc": "Temukan jajaran keripik tempe premium kami, dibuat dengan teliti untuk selera internasional namun tetap setia pada akar Indonesia kami.",
    "products.catalog": "Katalog Lengkap",

    // Home - Process Section
    "process.badge": "Seni Proses Pakuaty",
    "process.title_part1": "Dari Biji Menjadi",
    "process.title_part2": "Kerenyahan Emas",
    "process.step1_title": "Sumber Organik",
    "process.step1_desc": "Kami hanya memilih kedelai non-GMO terbaik dari petani mitra lokal.",
    "process.step2_title": "Fermentasi 48j",
    "process.step2_desc": "Teknik 'ragi' tradisional yang disempurnakan berabad-abad untuk nutrisi maksimal.",
    "process.step3_title": "Penipisan Pengrajin",
    "process.step3_desc": "Diiris dengan presisi mikroskopis untuk kerenyahan khas Pakuaty.",
    "process.step4_title": "Siap Ekspor",
    "process.step4_desc": "Disegel kedap udara dalam kemasan premium untuk kesegaran perjalanan global.",
