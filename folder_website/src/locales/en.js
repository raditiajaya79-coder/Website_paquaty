export const en = {
    ...
    // Hero Section
    "hero.subtitle_part1": "REDEFINING PROTEIN SNACKS",
    "hero.title_part1": "The Golden",
    "hero.title_part2": "Standard",
    "hero.subtitle_part2": "Artisan chips crafted through 48-hour traditional fermentation. Every slice tells a story of heritage.",
    ...
    "products.desc": "Discover our range of premium tempe chips, meticulously crafted for the international palate while staying true to our Indonesian roots.",
    "products.catalog": "Full Catalog",

    // Home - Process Section
    "process.badge": "The Pakuaty Process",
    "process.title_part1": "From Bean to",
    "process.title_part2": "Golden Crunch",
    "process.step1_title": "Organic Sourcing",
    "process.step1_desc": "We select only the finest non-GMO soybeans from local partner farmers.",
    "process.step2_title": "48h Fermentation",
    "process.step2_desc": "Traditional 'ragi' techniques perfected over centuries for maximum nutrition.",
    "process.step3_title": "Artisan Thinning",
    "process.step3_desc": "Sliced to microscopic precision for the signature Pakuaty crunch.",
    "process.step4_title": "Export Ready",
    "process.step4_desc": "Vacuum-sealed in premium packaging for global journey fresh arrival.",
