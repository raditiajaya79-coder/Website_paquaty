...
import { motion } from 'framer-motion'; // Library animasi transisi
...
const Sidebar = () => {
    ...
    return (
        // Aside container: fixed sidebar, hanya tampil di layar lg+
        <aside className="w-72 h-screen p-4 hidden lg:flex flex-col sticky top-0 z-50">
