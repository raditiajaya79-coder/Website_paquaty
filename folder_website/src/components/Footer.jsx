            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="flex flex-col md:flex-row justify-between items-start gap-10 mb-12">
                    ...
                    <div className="flex flex-wrap gap-16">
                        ...
                        <div>
                            <h4 className="font-bold text-stone-dark mb-8 text-[10px] uppercase tracking-[0.3em]">Legal</h4>
                            <ul className="space-y-4">
                                <li><a href="#" className="text-stone-dark/60 text-sm hover:text-brand-blue transition-all duration-300">Terms of Service</a></li>
                                <li><a href="#" className="text-stone-dark/60 text-sm hover:text-brand-blue transition-all duration-300">Privacy Policy</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center pt-6 border-t border-stone-border/30 gap-6">
                    <p className="text-xs font-bold text-stone-dark/30 uppercase tracking-widest">© {new Date().getFullYear()} {COMPANY_INFO.name}. International Standard Excellence.</p>
